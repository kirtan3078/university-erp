...
const dueAmount = useMemo(() => {
  return Math.max(totalFee - paidAmount, 0);
}, [totalFee, paidAmount]);
  ...
  const fetchFeeTemplates = async () => {
    try {
      ...
      setFeeTemplates(res.data.templates);
  ...
  >
    ...
    <div className="flex items-center justify-between">
      ...
      <div>
        ...
        <p className="mt-2 text-slate-400">
          Create student fee using reusable fee templates.
        </p>
      ...
      <div className="grid gap-6 p-8 md:grid-cols-2">
        ...
        <div>
          ...
          <select
            ...
            disabled={!student}
            className="w-full rounded-xl border border-slate-700 bg-slate-800 px-4 py-3 text-white outline-none disabled:opacity-50"
          >
    ...
    <div className="rounded-3xl border border-slate-700 bg-slate-900 shadow-xl">
      ...
      {!selectedTemplate ? (
        ...
        <div className="p-10 text-center text-slate-400">
          ...
          Please select a <span className="font-semibold text-cyan-400">Fee Template</span> to load the fee structure.
    ...
    <div className="rounded-3xl border border-slate-700 bg-slate-900 shadow-xl">
      ...
      <div className="border-b border-slate-700 px-8 py-6">
        ...
        <p className="mt-2 text-slate-400">
          Enter payment information for this fee record.
        </p>
